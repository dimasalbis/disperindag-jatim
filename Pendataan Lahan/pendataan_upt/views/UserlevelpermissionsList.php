...
<?php if ($Page->userlevelid->Visible) { // userlevelid ?>
        <th data-name="userlevelid" class="<?= $Page->userlevelid->headerCellClass() ?>"><div id="elh_userlevelpermissions_userlevelid" class="userlevelpermissions_userlevelid"><?= $Page->renderSort($Page->userlevelid) ?></div></th>
<?php } ?>
...
<?php if ($Page->_permission->Visible) { // permission ?>
        <th data-name="_permission" class="<?= $Page->_permission->headerCellClass() ?>"><div id="elh_userlevelpermissions__permission" class="userlevelpermissions__permission"><?= $Page->renderSort($Page->_permission) ?></div></th>
<?php } ?>
<?php
...
<span id="el<?= $Page->RowCount ?>_userlevelpermissions_userlevelid">
...
<span id="el<?= $Page->RowCount ?>_userlevelpermissions__permission">
