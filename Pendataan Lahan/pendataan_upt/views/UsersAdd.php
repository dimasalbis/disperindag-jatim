...
loadjs.ready(["fusersadd", "datetimepicker"], function() {
    ew.createDateTimePicker("fusersadd", "x_email_verified_at", {"ignoreReadonly":true,"useCurrent":false,"format":0});
});
</script>
<?php } ?>
</span>
...
<script>
loadjs.ready(["fusersadd", "datetimepicker"], function() {
    ew.createDateTimePicker("fusersadd", "x_updated_at", {"ignoreReadonly":true,"useCurrent":false,"format":0});
});
</script>
<?php } ?>
</span>
