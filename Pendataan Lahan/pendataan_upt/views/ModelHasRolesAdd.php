...
// Page object
$ModelHasRolesAdd = &$Page;
?>
<script>
var currentForm, currentPageID;
var fmodel_has_rolesadd;
loadjs.ready("head", function () {
    var $ = jQuery;
    // Form object
    currentPageID = ew.PAGE_ID = "add";
    fmodel_has_rolesadd = currentForm = new ew.Form("fmodel_has_rolesadd", "add");
    ...
    // Validate form
    fmodel_has_rolesadd.validate = function () {
    ...
    // Form_CustomValidate
    fmodel_has_rolesadd.customValidate = function(fobj) { // DO NOT CHANGE THIS LINE!
        // Your custom validation code here, return false if invalid.
        return true;
    }

    // Use JavaScript validation or not
    fmodel_has_rolesadd.validateRequired = <?= Config("CLIENT_VALIDATE") ? "true" : "false" ?>;

    // Dynamic selection lists
    loadjs.done("fmodel_has_rolesadd");
});
</script>
<script>
loadjs.ready("head", function () {
...
$Page->showMessage();
?>
<form name="fmodel_has_rolesadd" id="fmodel_has_rolesadd" class="<?= $Page->FormClassName ?>" action="<?= CurrentPageUrl(false) ?>" method="post">
