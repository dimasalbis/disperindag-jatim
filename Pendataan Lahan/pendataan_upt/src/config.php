...
$CONFIG = [
    ...
    "RANDOM_KEY" => '0U22GcKKwgTsFDg1', // Random key for encryption
    ...
    "NAVBAR_CLASS" => "main-header navbar navbar-expand navbar-danger navbar-dark border-bottom-0",
    ...
    "ADMIN_USER_NAME" => "harun ", // Administrator user name
    "ADMIN_PASSWORD" => "harunyahya1234", // Administrator password
    ...
    "MAX_FILE_SIZE" => 1000000000, // Max file size
