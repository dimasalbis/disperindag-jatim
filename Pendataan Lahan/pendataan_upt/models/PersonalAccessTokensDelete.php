 ...
 * Page class
 */
class PersonalAccessTokensDelete extends PersonalAccessTokens
{
    use MessagesTrait;
    ...
    // Page object name
    public $PageObjName = "PersonalAccessTokensDelete";
    ...
    public function run()
    {
        ...
        if ($filter == "") {
            $this->terminate("personalaccesstokenslist"); // Prevent SQL injection, return to list
            return;
        }
        ...
        if ($this->isShow()) { // Load records for display
            ...
            if ($this->TotalRecords <= 0) { // No record found, exit
                ...
                $this->terminate("personalaccesstokenslist"); // Return to list
                return;
            }
        }
