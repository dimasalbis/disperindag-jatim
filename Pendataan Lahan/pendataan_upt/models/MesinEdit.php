...
class MesinEdit extends Mesin
{
    ...
    protected function editRow()
    {
        ...
        if (!$rsold) {
            ...
            // gambar_mesin
            $this->gambar_mesin->setDbValueDef($rsnew, $this->gambar_mesin->CurrentValue, null, $this->gambar_mesin->ReadOnly);
