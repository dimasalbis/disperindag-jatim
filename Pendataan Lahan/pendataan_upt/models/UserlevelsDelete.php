...
class UserlevelsDelete extends Userlevels
{
    ...
    // Page object name
    public $PageObjName = "UserlevelsDelete";
        ...
        if ($deleteRows) {
            ...
            foreach ($rsold as $row) {
                ...
                if ($x_userlevelid != null) {
                    $conn->executeUpdate("DELETE FROM " . Config("USER_LEVEL_PRIV_TABLE") . " WHERE " . Config("USER_LEVEL_PRIV_USER_LEVEL_ID_FIELD") . " = " . $x_userlevelid); // Delete user rights as well
                }
            }
        }
        if (!$deleteRows) {
