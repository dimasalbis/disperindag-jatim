 ...
 * Page class
 */
class PendataanDelete extends Pendataan
{
    use MessagesTrait;
    ...
    // Page object name
    public $PageObjName = "PendataanDelete";
    ...
    public function run()
    {
        ...
        if ($filter == "") {
            $this->terminate("pendataanlist"); // Prevent SQL injection, return to list
            return;
        }
        ...
        if ($this->isShow()) { // Load records for display
            ...
            if ($this->TotalRecords <= 0) { // No record found, exit
                ...
                $this->terminate("pendataanlist"); // Return to list
                return;
            }
        }
