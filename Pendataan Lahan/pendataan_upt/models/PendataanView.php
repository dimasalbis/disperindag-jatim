 ...
 * Page class
 */
class PendataanView extends Pendataan
{
    use MessagesTrait;
    ...
    // Page object name
    public $PageObjName = "PendataanView";
    ...
    public function run()
    {
        ...
        if ($this->isPageRequest()) { // Validate request
            if (($keyValue = Get("id") ?? Route("id")) !== null) {
                ...
                $returnUrl = "pendataanlist"; // Return to list
            }
            ...
            switch ($this->CurrentAction) {
                case "show": // Get a record to display
                    ...
                    if (!$res) { // Load record based on key
                        ...
                        $returnUrl = "pendataanlist"; // No matching record, return to list
                    }
                    break;
            }
        } else {
            $returnUrl = "pendataanlist"; // Not page request, return to list
        }
        if ($returnUrl != "") {
