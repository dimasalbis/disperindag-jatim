 ...
 * Page class
 */
class PendataanList extends Pendataan
{
    use MessagesTrait;
    ...
    // Page object name
    public $PageObjName = "PendataanList";

    // Rendering View
    public $RenderingView = false;

    // Grid form hidden field names
    public $FormName = "fpendataanlist";
    ...
    public function __construct()
    {
        ...
        $this->AddUrl = "pendataanadd";
        $this->InlineAddUrl = $pageUrl . "action=add";
        $this->GridAddUrl = $pageUrl . "action=gridadd";
        $this->GridEditUrl = $pageUrl . "action=gridedit";
        $this->MultiDeleteUrl = "pendataandelete";
        $this->MultiUpdateUrl = "pendataanupdate";
        ...
        $this->FilterOptions->TagClassName = "ew-filter-option fpendataanlistsrch";
    ...
    public function getFilterList()
    {
        ...
        $filterList = Concat($filterList, $this->create_at->AdvancedSearch->toJson(), ","); // Field create_at
    ...
    protected function processFilterList()
    {
        ...
        if (Post("ajax") == "savefilters") { // Save filter request (Ajax)
            ...
            $UserProfile->setSearchFilters(CurrentUserName(), "fpendataanlistsrch", $filters);
    ...
    protected function restoreFilterList()
    {
        ...
        // Field create_at
        $this->create_at->AdvancedSearch->SearchValue = @$filter["x_create_at"];
        $this->create_at->AdvancedSearch->SearchOperator = @$filter["z_create_at"];
        $this->create_at->AdvancedSearch->SearchCondition = @$filter["v_create_at"];
        $this->create_at->AdvancedSearch->SearchValue2 = @$filter["y_create_at"];
        $this->create_at->AdvancedSearch->SearchOperator2 = @$filter["w_create_at"];
        $this->create_at->AdvancedSearch->save();
    ...
    protected function basicSearchSql($arKeywords, $type)
    {
        ...
        $this->buildBasicSearchSql($where, $this->lokasi_lahan, $arKeywords, $type);
        $this->buildBasicSearchSql($where, $this->luas_lahan, $arKeywords, $type);
    ...
    protected function setupSortOrder()
    {
        ...
        if (Get("order") !== null) {
            ...
            $this->updateSort($this->create_at); // create_at
    ...
    protected function setupOtherOptions()
    {
        ...
        $item->Body = "<a class=\"ew-save-filter\" data-form=\"fpendataanlistsrch\" href=\"#\" onclick=\"return false;\">" . $Language->phrase("SaveCurrentFilter") . "</a>";
        $item->Visible = true;
        $item = &$this->FilterOptions->add("deletefilter");
        $item->Body = "<a class=\"ew-delete-filter\" data-form=\"fpendataanlistsrch\" href=\"#\" onclick=\"return false;\">" . $Language->phrase("DeleteFilter") . "</a>";
        $item->Visible = true;
    ...
    public function renderOtherOptions()
    {
        ...
        foreach ($this->ListActions->Items as $listaction) {
            if ($listaction->Select == ACTION_MULTIPLE) {
                ...
                $item->Body = '<a class="ew-action ew-list-action" title="' . HtmlEncode($caption) . '" data-caption="' . HtmlEncode($caption) . '" href="#" onclick="return ew.submitAction(event,jQuery.extend({f:document.fpendataanlist},' . $listaction->toJson(true) . '));">' . $icon . '</a>';
    ...
    protected function setupSearchOptions()
    {
        ...
        $item->Body = "<a class=\"btn btn-default ew-search-toggle" . $searchToggleClass . "\" href=\"#\" role=\"button\" title=\"" . $Language->phrase("SearchPanel") . "\" data-caption=\"" . $Language->phrase("SearchPanel") . "\" data-toggle=\"button\" data-form=\"fpendataanlistsrch\" aria-pressed=\"" . ($searchToggleClass == " active" ? "true" : "false") . "\">" . $Language->phrase("SearchLink") . "</a>";
        $item->Visible = true;
