 ...
 * Page class
 */
class PendataanEdit extends Pendataan
{
    use MessagesTrait;
    ...
    // Page object name
    public $PageObjName = "PendataanEdit";
    ...
    protected function editRow()
    {
        ...
        if (!$rsold) {
            ...
            // lokasi_lahan
            $this->lokasi_lahan->setDbValueDef($rsnew, $this->lokasi_lahan->CurrentValue, "", $this->lokasi_lahan->ReadOnly);
            ...
            // luas_lahan
            $this->luas_lahan->setDbValueDef($rsnew, $this->luas_lahan->CurrentValue, "", $this->luas_lahan->ReadOnly);
            ...
            if ($this->legalitas->Visible && !$this->legalitas->Upload->KeepFile) {
                ...
                if (!EmptyValue($this->legalitas->Upload->FileName)) {
                    ...
                    $this->legalitas->setDbValueDef($rsnew, $this->legalitas->Upload->FileName, null, $this->legalitas->ReadOnly);
                }
            }
