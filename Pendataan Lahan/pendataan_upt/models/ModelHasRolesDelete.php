 ...
 * Page class
 */
class ModelHasRolesDelete extends ModelHasRoles
{
    use MessagesTrait;
    ...
    // Page object name
    public $PageObjName = "ModelHasRolesDelete";
    ...
    public function run()
    {
        ...
        if ($filter == "") {
            $this->terminate("modelhasroleslist"); // Prevent SQL injection, return to list
            return;
        }
        ...
        if ($this->isShow()) { // Load records for display
            ...
            if ($this->TotalRecords <= 0) { // No record found, exit
                ...
                $this->terminate("modelhasroleslist"); // Return to list
                return;
            }
        }
    ...
    protected function deleteRows()
    {
        ...
        if ($deleteRows) {
            ...
            foreach ($rsold as $row) {
                ...
                $thisKey .= $row['model_type'];
                if ($thisKey != "") {
                    $thisKey .= Config("COMPOSITE_KEY_SEPARATOR");
                }
                $thisKey .= $row['model_id'];
