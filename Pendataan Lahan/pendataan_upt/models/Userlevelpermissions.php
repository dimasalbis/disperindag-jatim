 ...
 */
class Userlevelpermissions extends DbTable
{
    protected $SqlFrom = "";
    ...
    public function __construct()
    {
        ...
        // Update Table
        $this->UpdateTable = "`userlevelpermissions`";
        $this->Dbid = 'DB';
        $this->ExportAll = true;
        ...
        // userlevelid
        $this->userlevelid = new DbField('userlevelpermissions', 'userlevelpermissions', 'x_userlevelid', 'userlevelid', '`userlevelid`', '`userlevelid`', 3, 11, -1, false, '`userlevelid`', false, false, false, 'FORMATTED TEXT', 'TEXT');
        ...
        $this->userlevelid->CustomMsg = $Language->FieldPhrase($this->TableVar, $this->userlevelid->Param, "CustomMsg");
        $this->Fields['userlevelid'] = &$this->userlevelid;

        // tablename
        $this->_tablename = new DbField('userlevelpermissions', 'userlevelpermissions', 'x__tablename', 'tablename', '`tablename`', '`tablename`', 200, 80, -1, false, '`tablename`', false, false, false, 'FORMATTED TEXT', 'TEXT');
        ...
        $this->_tablename->CustomMsg = $Language->FieldPhrase($this->TableVar, $this->_tablename->Param, "CustomMsg");
        $this->Fields['tablename'] = &$this->_tablename;

        // permission
        $this->_permission = new DbField('userlevelpermissions', 'userlevelpermissions', 'x__permission', 'permission', '`permission`', '`permission`', 3, 11, -1, false, '`permission`', false, false, false, 'FORMATTED TEXT', 'TEXT');
    ...
    public function getRecordFilter($row = null)
    {
        ...
        if (is_array($row)) {
            ...
            $val = $this->userlevelid->OldValue !== null ? $this->userlevelid->OldValue : $this->userlevelid->CurrentValue;
        }
        if (!is_numeric($val)) {
        ...
        if (is_array($row)) {
            ...
            $val = $this->_tablename->OldValue !== null ? $this->_tablename->OldValue : $this->_tablename->CurrentValue;
        }
        if ($val === null) {
            return "0=1"; // Invalid key
        } else {
    ...
    public function getReturnUrl()
    {
        ...
        return $_SESSION[$name] ?? GetUrl("userlevelpermissionslist");
    }
    ...
    {
        global $Language;
        if ($pageName == "userlevelpermissionsview") {
            return $Language->phrase("View");
        } elseif ($pageName == "userlevelpermissionsedit") {
            return $Language->phrase("Edit");
        } elseif ($pageName == "userlevelpermissionsadd") {
    ...
    public function getApiPageName($action)
    {
        switch (strtolower($action)) {
            case Config("API_VIEW_ACTION"):
                return "UserlevelpermissionsView";
            case Config("API_ADD_ACTION"):
                return "UserlevelpermissionsAdd";
            case Config("API_EDIT_ACTION"):
                return "UserlevelpermissionsEdit";
            case Config("API_DELETE_ACTION"):
                return "UserlevelpermissionsDelete";
    ...
    {
        if ($parm != "") {
            $url = $this->keyUrl("userlevelpermissionsview", $this->getUrlParm($parm));
        } else {
            $url = $this->keyUrl("userlevelpermissionsview", $this->getUrlParm(Config("TABLE_SHOW_DETAIL") . "="));
        }
    ...
    {
        if ($parm != "") {
            $url = "userlevelpermissionsadd?" . $this->getUrlParm($parm);
        } else {
    ...
    {
        $url = $this->keyUrl("userlevelpermissionsedit", $this->getUrlParm($parm));
        return $this->addMasterUrl($url);
    }
    ...
    {
        $url = $this->keyUrl("userlevelpermissionsadd", $this->getUrlParm($parm));
        return $this->addMasterUrl($url);
    }
    ...
    {
        return $this->keyUrl("userlevelpermissionsdelete", $this->getUrlParm());
    }
    ...
    public function keyUrl($url, $parm = "")
    {
        if ($this->userlevelid->CurrentValue !== null) {
            $url .= "/" . rawurlencode($this->userlevelid->CurrentValue);
        } else {
            return "javascript:ew.alert(ew.language.phrase('InvalidRecord'));";
        }
        if ($this->_tablename->CurrentValue !== null) {
            $url .= "/" . rawurlencode($this->_tablename->CurrentValue);
        } else {
            return "javascript:ew.alert(ew.language.phrase('InvalidRecord'));";
        }
        if ($parm != "") {
...
SORTHTML;
    ...
    public function renderListRow()
    {
        ...
        $this->_permission->ViewValue = FormatNumber($this->_permission->ViewValue, 0, -2, -2, -2);
        $this->_permission->ViewCustomAttributes = "";
        ...
        // permission
        $this->_permission->LinkCustomAttributes = "";
    ...
    public function renderEditRow()
    {
        ...
        // permission
        $this->_permission->EditAttrs["class"] = "form-control";
        $this->_permission->EditCustomAttributes = "";
