...
// Page object
$PelatihanSiswaEdit = &$Page;
?>
<script>
var currentForm, currentPageID;
var fpelatihan_siswaedit;
loadjs.ready("head", function () {
    var $ = jQuery;
    // Form object
    currentPageID = ew.PAGE_ID = "edit";
    fpelatihan_siswaedit = currentForm = new ew.Form("fpelatihan_siswaedit", "edit");
    ...
    fpelatihan_siswaedit.addFields([
    ...
    // Validate form
    fpelatihan_siswaedit.validate = function () {
    ...
    // Form_CustomValidate
    fpelatihan_siswaedit.customValidate = function(fobj) { // DO NOT CHANGE THIS LINE!
        // Your custom validation code here, return false if invalid.
        return true;
    }

    // Use JavaScript validation or not
    fpelatihan_siswaedit.validateRequired = <?= Config("CLIENT_VALIDATE") ? "true" : "false" ?>;

    // Dynamic selection lists
    fpelatihan_siswaedit.lists.jenis_kelamin = <?= $Page->jenis_kelamin->toClientList($Page) ?>;
    loadjs.done("fpelatihan_siswaedit");
});
</script>
<script>
loadjs.ready("head", function () {
...
$Page->showMessage();
?>
<form name="fpelatihan_siswaedit" id="fpelatihan_siswaedit" class="<?= $Page->FormClassName ?>" action="<?= CurrentPageUrl(false) ?>" method="post">
...
<script>
loadjs.ready(["fpelatihan_siswaedit", "datetimepicker"], function() {
    ew.createDateTimePicker("fpelatihan_siswaedit", "x_tanggal_lahir", {"ignoreReadonly":true,"useCurrent":false,"format":0});
});
</script>
<?php } ?>
</span>
...
<?php } ?>
    ...
    <input type="hidden" data-table="pelatihan_siswa" data-field="x_id" data-hidden="1" name="x_id" id="x_id" value="<?= HtmlEncode($Page->id->CurrentValue) ?>">
<?php if (!$Page->IsModal) { ?>
