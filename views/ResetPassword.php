...
<p class="login-box-msg"><?= $Language->phrase("ResetPwdMsg") ?></p>
    <div class="form-group row">
        <input type="text" name="<?= $Page->Email->FieldVar ?>" id="<?= $Page->Email->FieldVar ?>" value="<?= HtmlEncode($Page->Email->CurrentValue) ?>" size="30" maxlength="255" placeholder="<?= HtmlEncode($Language->phrase("UserEmail")) ?>"<?= $Page->Email->editAttributes() ?>>
