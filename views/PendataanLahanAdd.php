...
// Page object
$PendataanLahanAdd = &$Page;
?>
<script>
var currentForm, currentPageID;
var fpendataan_lahanadd;
loadjs.ready("head", function () {
    var $ = jQuery;
    // Form object
    currentPageID = ew.PAGE_ID = "add";
    fpendataan_lahanadd = currentForm = new ew.Form("fpendataan_lahanadd", "add");
    ...
    // Validate form
    fpendataan_lahanadd.validate = function () {
    ...
    // Form_CustomValidate
    fpendataan_lahanadd.customValidate = function(fobj) { // DO NOT CHANGE THIS LINE!
        // Your custom validation code here, return false if invalid.
        return true;
    }

    // Use JavaScript validation or not
    fpendataan_lahanadd.validateRequired = <?= Config("CLIENT_VALIDATE") ? "true" : "false" ?>;

    // Dynamic selection lists
    loadjs.done("fpendataan_lahanadd");
});
</script>
<script>
loadjs.ready("head", function () {
...
$Page->showMessage();
?>
<form name="fpendataan_lahanadd" id="fpendataan_lahanadd" class="<?= $Page->FormClassName ?>" action="<?= CurrentPageUrl(false) ?>" method="post">
...
<input type="hidden" name="fa_x_upload_legalitas" id= "fa_x_upload_legalitas" value="0">
...
<input type="hidden" name="fa_x_foto_lahan" id= "fa_x_foto_lahan" value="0">
...
<div id="tpd_pendataan_lahanadd" class="ew-custom-template"></div>
<template id="tpm_pendataan_lahanadd">
<div id="ct_PendataanLahanAdd"><?php require_once('pendataan-lahan.php'); ?>
</div>
</template>
<?php if (!$Page->IsModal) { ?>
...
loadjs.ready(["jsrender", "makerjs"], function() {
    ...
    ew.applyTemplate("tpd_pendataan_lahanadd", "tpm_pendataan_lahanadd", "pendataan_lahanadd", "<?= $Page->CustomExport ?>", ew.templateData.rows[0]);
