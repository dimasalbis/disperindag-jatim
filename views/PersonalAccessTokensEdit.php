...
loadjs.ready("head", function () {
    ...
    fpersonal_access_tokensedit = currentForm = new ew.Form("fpersonal_access_tokensedit", "edit");
    ...
    fpersonal_access_tokensedit.addFields([
    ...
    // Set invalid fields
    $(function() {
        var f = fpersonal_access_tokensedit,
            fobj = f.getForm(),
            $fobj = $(fobj),
    ...
    // Validate form
    fpersonal_access_tokensedit.validate = function () {
    ...
    // Form_CustomValidate
    fpersonal_access_tokensedit.customValidate = function(fobj) { // DO NOT CHANGE THIS LINE!
        // Your custom validation code here, return false if invalid.
        return true;
    }

    // Use JavaScript validation or not
    fpersonal_access_tokensedit.validateRequired = <?= Config("CLIENT_VALIDATE") ? "true" : "false" ?>;

    // Dynamic selection lists
    loadjs.done("fpersonal_access_tokensedit");
});
</script>
<script>
loadjs.ready("head", function () {
...
$Page->showMessage();
?>
<form name="fpersonal_access_tokensedit" id="fpersonal_access_tokensedit" class="<?= $Page->FormClassName ?>" action="<?= CurrentPageUrl(false) ?>" method="post">
...
loadjs.ready(["fpersonal_access_tokensedit", "datetimepicker"], function() {
    ew.createDateTimePicker("fpersonal_access_tokensedit", "x_last_used_at", {"ignoreReadonly":true,"useCurrent":false,"format":0});
});
</script>
<?php } ?>
</span>
...
<script>
loadjs.ready(["fpersonal_access_tokensedit", "datetimepicker"], function() {
    ew.createDateTimePicker("fpersonal_access_tokensedit", "x_expires_at", {"ignoreReadonly":true,"useCurrent":false,"format":0});
});
</script>
<?php } ?>
</span>
...
<script>
loadjs.ready(["fpersonal_access_tokensedit", "datetimepicker"], function() {
    ew.createDateTimePicker("fpersonal_access_tokensedit", "x_created_at", {"ignoreReadonly":true,"useCurrent":false,"format":0});
});
</script>
<?php } ?>
</span>
...
<script>
loadjs.ready(["fpersonal_access_tokensedit", "datetimepicker"], function() {
    ew.createDateTimePicker("fpersonal_access_tokensedit", "x_updated_at", {"ignoreReadonly":true,"useCurrent":false,"format":0});
});
</script>
<?php } ?>
</span>
