...
// Page object
$PerusahaanPenampungEdit = &$Page;
?>
<script>
var currentForm, currentPageID;
var fperusahaan_penampungedit;
loadjs.ready("head", function () {
    var $ = jQuery;
    // Form object
    currentPageID = ew.PAGE_ID = "edit";
    fperusahaan_penampungedit = currentForm = new ew.Form("fperusahaan_penampungedit", "edit");
    ...
    fperusahaan_penampungedit.addFields([
    ...
    // Set invalid fields
    $(function() {
        var f = fperusahaan_penampungedit,
            fobj = f.getForm(),
            $fobj = $(fobj),
    ...
    // Validate form
    fperusahaan_penampungedit.validate = function () {
    ...
    // Form_CustomValidate
    fperusahaan_penampungedit.customValidate = function(fobj) { // DO NOT CHANGE THIS LINE!
        // Your custom validation code here, return false if invalid.
        return true;
    }

    // Use JavaScript validation or not
    fperusahaan_penampungedit.validateRequired = <?= Config("CLIENT_VALIDATE") ? "true" : "false" ?>;

    // Dynamic selection lists
    loadjs.done("fperusahaan_penampungedit");
});
</script>
<script>
loadjs.ready("head", function () {
...
$Page->showMessage();
?>
<form name="fperusahaan_penampungedit" id="fperusahaan_penampungedit" class="<?= $Page->FormClassName ?>" action="<?= CurrentPageUrl(false) ?>" method="post">
...
<?php } ?>
    ...
    <input type="hidden" data-table="perusahaan_penampung" data-field="x_id" data-hidden="1" name="x_id" id="x_id" value="<?= HtmlEncode($Page->id->CurrentValue) ?>">
<div id="tpd_perusahaan_penampungedit" class="ew-custom-template"></div>
<template id="tpm_perusahaan_penampungedit">
<div id="ct_PerusahaanPenampungEdit"><?php require_once('perusahaan-penampung.php'); ?>
</div>
</template>
<?php if (!$Page->IsModal) { ?>
...
loadjs.ready(["jsrender", "makerjs"], function() {
    ...
    ew.applyTemplate("tpd_perusahaan_penampungedit", "tpm_perusahaan_penampungedit", "perusahaan_penampungedit", "<?= $Page->CustomExport ?>", ew.templateData.rows[0]);
