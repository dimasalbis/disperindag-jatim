...
// Page object
$PenyewaanMesinAdd = &$Page;
?>
<script>
var currentForm, currentPageID;
var fpenyewaan_mesinadd;
loadjs.ready("head", function () {
    var $ = jQuery;
    // Form object
    currentPageID = ew.PAGE_ID = "add";
    fpenyewaan_mesinadd = currentForm = new ew.Form("fpenyewaan_mesinadd", "add");
    ...
    // Validate form
    fpenyewaan_mesinadd.validate = function () {
    ...
    // Form_CustomValidate
    fpenyewaan_mesinadd.customValidate = function(fobj) { // DO NOT CHANGE THIS LINE!
        // Your custom validation code here, return false if invalid.
        return true;
    }

    // Use JavaScript validation or not
    fpenyewaan_mesinadd.validateRequired = <?= Config("CLIENT_VALIDATE") ? "true" : "false" ?>;

    // Dynamic selection lists
    loadjs.done("fpenyewaan_mesinadd");
});
</script>
<script>
loadjs.ready("head", function () {
...
$Page->showMessage();
?>
<form name="fpenyewaan_mesinadd" id="fpenyewaan_mesinadd" class="<?= $Page->FormClassName ?>" action="<?= CurrentPageUrl(false) ?>" method="post">
...
<script>
loadjs.ready(["fpenyewaan_mesinadd", "datetimepicker"], function() {
    ew.createDateTimePicker("fpenyewaan_mesinadd", "x_tanggal_sewa", {"ignoreReadonly":true,"useCurrent":false,"format":0});
});
</script>
<?php } ?>
</span>
...
<script>
loadjs.ready(["fpenyewaan_mesinadd", "datetimepicker"], function() {
    ew.createDateTimePicker("fpenyewaan_mesinadd", "x_tanggal_kembali", {"ignoreReadonly":true,"useCurrent":false,"format":0});
});
</script>
<?php } ?>
</span>
