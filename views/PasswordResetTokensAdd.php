...
// Page object
$PasswordResetTokensAdd = &$Page;
?>
<script>
var currentForm, currentPageID;
var fpassword_reset_tokensadd;
loadjs.ready("head", function () {
    var $ = jQuery;
    // Form object
    currentPageID = ew.PAGE_ID = "add";
    fpassword_reset_tokensadd = currentForm = new ew.Form("fpassword_reset_tokensadd", "add");
    ...
    fpassword_reset_tokensadd.addFields([
    ...
    // Set invalid fields
    $(function() {
        var f = fpassword_reset_tokensadd,
            fobj = f.getForm(),
            $fobj = $(fobj),
    ...
    // Validate form
    fpassword_reset_tokensadd.validate = function () {
    ...
    // Form_CustomValidate
    fpassword_reset_tokensadd.customValidate = function(fobj) { // DO NOT CHANGE THIS LINE!
        // Your custom validation code here, return false if invalid.
        return true;
    }

    // Use JavaScript validation or not
    fpassword_reset_tokensadd.validateRequired = <?= Config("CLIENT_VALIDATE") ? "true" : "false" ?>;

    // Dynamic selection lists
    loadjs.done("fpassword_reset_tokensadd");
});
</script>
<script>
loadjs.ready("head", function () {
...
$Page->showMessage();
?>
<form name="fpassword_reset_tokensadd" id="fpassword_reset_tokensadd" class="<?= $Page->FormClassName ?>" action="<?= CurrentPageUrl(false) ?>" method="post">
...
<script>
loadjs.ready(["fpassword_reset_tokensadd", "datetimepicker"], function() {
    ew.createDateTimePicker("fpassword_reset_tokensadd", "x_created_at", {"ignoreReadonly":true,"useCurrent":false,"format":0});
});
</script>
<?php } ?>
</span>
