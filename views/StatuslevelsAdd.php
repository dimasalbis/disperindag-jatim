...
// Page object
$StatuslevelsAdd = &$Page;
?>
<script>
var currentForm, currentPageID;
var fstatuslevelsadd;
loadjs.ready("head", function () {
    var $ = jQuery;
    // Form object
    currentPageID = ew.PAGE_ID = "add";
    fstatuslevelsadd = currentForm = new ew.Form("fstatuslevelsadd", "add");
    ...
    // Validate form
    fstatuslevelsadd.validate = function () {
    ...
    // Form_CustomValidate
    fstatuslevelsadd.customValidate = function(fobj) { // DO NOT CHANGE THIS LINE!
        // Your custom validation code here, return false if invalid.
        return true;
    }

    // Use JavaScript validation or not
    fstatuslevelsadd.validateRequired = <?= Config("CLIENT_VALIDATE") ? "true" : "false" ?>;

    // Dynamic selection lists
    loadjs.done("fstatuslevelsadd");
});
</script>
<script>
loadjs.ready("head", function () {
...
$Page->showMessage();
?>
<form name="fstatuslevelsadd" id="fstatuslevelsadd" class="<?= $Page->FormClassName ?>" action="<?= CurrentPageUrl(false) ?>" method="post">
