 ...
 * Page class
 */
class PendataanLahanEdit extends PendataanLahan
{
    use MessagesTrait;
    ...
    // Page object name
    public $PageObjName = "PendataanLahanEdit";
        ...
        if (IsApi()) {
            ...
            if ($this->isShow()) {
                ...
                if ($this->TotalRecords <= 0) { // No record found
                    ...
                    $this->terminate("pendataanlahanlist"); // Return to list page
                    return;
    ...
    protected function editRow()
    {
        ...
        if (!$rsold) {
            ...
            // nama_ikm
            $this->nama_ikm->setDbValueDef($rsnew, $this->nama_ikm->CurrentValue, "", $this->nama_ikm->ReadOnly);

            // penanggung_jawab
            $this->penanggung_jawab->setDbValueDef($rsnew, $this->penanggung_jawab->CurrentValue, "", $this->penanggung_jawab->ReadOnly);
            ...
            // lokasi_lahan
            $this->lokasi_lahan->setDbValueDef($rsnew, $this->lokasi_lahan->CurrentValue, null, $this->lokasi_lahan->ReadOnly);

            // luas_lahan
            $this->luas_lahan->setDbValueDef($rsnew, $this->luas_lahan->CurrentValue, null, $this->luas_lahan->ReadOnly);

            // nilai_sewa
            $this->nilai_sewa->setDbValueDef($rsnew, $this->nilai_sewa->CurrentValue, null, $this->nilai_sewa->ReadOnly);

            // upload_legalitas
            if ($this->upload_legalitas->Visible && !$this->upload_legalitas->ReadOnly && !$this->upload_legalitas->Upload->KeepFile) {
                $this->upload_legalitas->Upload->DbValue = $rsold['upload_legalitas']; // Get original value
            ...
            // foto_lahan
            if ($this->foto_lahan->Visible && !$this->foto_lahan->ReadOnly && !$this->foto_lahan->Upload->KeepFile) {
                $this->foto_lahan->Upload->DbValue = $rsold['foto_lahan']; // Get original value
            ...
            if ($this->upload_legalitas->Visible && !$this->upload_legalitas->Upload->KeepFile) {
                ...
                if (!EmptyValue($this->upload_legalitas->Upload->FileName)) {
                    ...
                    $this->upload_legalitas->setDbValueDef($rsnew, $this->upload_legalitas->Upload->FileName, null, $this->upload_legalitas->ReadOnly);
                }
            }
            if ($this->foto_lahan->Visible && !$this->foto_lahan->Upload->KeepFile) {
                ...
                if (!EmptyValue($this->foto_lahan->Upload->FileName)) {
                    ...
                    $this->foto_lahan->setDbValueDef($rsnew, $this->foto_lahan->Upload->FileName, null, $this->foto_lahan->ReadOnly);
                }
            }
