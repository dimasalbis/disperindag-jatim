...
/**
 * Table class for m_mesin
 */
class MMesin extends DbTable
{
    protected $SqlFrom = "";
    ...
    public function __construct()
    {
        ...
        $this->TableVar = 'm_mesin';
        $this->TableName = 'm_mesin';
        $this->TableType = 'TABLE';

        // Update Table
        $this->UpdateTable = "`m_mesin`";
        $this->Dbid = 'DB';
        $this->ExportAll = true;
        ...
        // id
        $this->id = new DbField('m_mesin', 'm_mesin', 'x_id', 'id', '`id`', '`id`', 21, 20, -1, false, '`id`', false, false, false, 'FORMATTED TEXT', 'NO');
        ...
        // gambar_mesin
        $this->gambar_mesin = new DbField('m_mesin', 'm_mesin', 'x_gambar_mesin', 'gambar_mesin', '`gambar_mesin`', '`gambar_mesin`', 200, 255, -1, true, '`gambar_mesin`', false, false, false, 'IMAGE', 'FILE');
        ...
        // nama_mesin
        $this->nama_mesin = new DbField('m_mesin', 'm_mesin', 'x_nama_mesin', 'nama_mesin', '`nama_mesin`', '`nama_mesin`', 200, 255, -1, false, '`nama_mesin`', false, false, false, 'FORMATTED TEXT', 'TEXT');
        ...
        // jumlah
        $this->jumlah = new DbField('m_mesin', 'm_mesin', 'x_jumlah', 'jumlah', '`jumlah`', '`jumlah`', 200, 255, -1, false, '`jumlah`', false, false, false, 'FORMATTED TEXT', 'TEXT');
        ...
        // dalam_penyewaan
        $this->dalam_penyewaan = new DbField('m_mesin', 'm_mesin', 'x_dalam_penyewaan', 'dalam_penyewaan', '`dalam_penyewaan`', '`dalam_penyewaan`', 200, 255, -1, false, '`dalam_penyewaan`', false, false, false, 'FORMATTED TEXT', 'TEXT');
        $this->dalam_penyewaan->Sortable = true; // Allow sort
        $this->dalam_penyewaan->CustomMsg = $Language->FieldPhrase($this->TableVar, $this->dalam_penyewaan->Param, "CustomMsg");
        $this->Fields['dalam_penyewaan'] = &$this->dalam_penyewaan;

        // sisa_barang
        $this->sisa_barang = new DbField('m_mesin', 'm_mesin', 'x_sisa_barang', 'sisa_barang', '`sisa_barang`', '`sisa_barang`', 200, 255, -1, false, '`sisa_barang`', false, false, false, 'FORMATTED TEXT', 'TEXT');
        $this->sisa_barang->Sortable = true; // Allow sort
        $this->sisa_barang->CustomMsg = $Language->FieldPhrase($this->TableVar, $this->sisa_barang->Param, "CustomMsg");
        $this->Fields['sisa_barang'] = &$this->sisa_barang;

        // keterangan
        $this->keterangan = new DbField('m_mesin', 'm_mesin', 'x_keterangan', 'keterangan', '`keterangan`', '`keterangan`', 200, 255, -1, false, '`keterangan`', false, false, false, 'FORMATTED TEXT', 'TEXTAREA');
        ...
        // created_at
        $this->created_at = new DbField('m_mesin', 'm_mesin', 'x_created_at', 'created_at', '`created_at`', CastDateFieldForLike("`created_at`", 0, "DB"), 135, 19, 0, false, '`created_at`', false, false, false, 'FORMATTED TEXT', 'TEXT');
        ...
        // updated_at
        $this->updated_at = new DbField('m_mesin', 'm_mesin', 'x_updated_at', 'updated_at', '`updated_at`', CastDateFieldForLike("`updated_at`", 0, "DB"), 135, 19, 0, false, '`updated_at`', false, false, false, 'FORMATTED TEXT', 'TEXT');
    ...
    {
        return ($this->SqlFrom != "") ? $this->SqlFrom : "`m_mesin`";
    }
    ...
    protected function loadDbValues($row)
    {
        ...
        $this->dalam_penyewaan->DbValue = $row['dalam_penyewaan'];
        $this->sisa_barang->DbValue = $row['sisa_barang'];
    ...
    public function getReturnUrl()
    {
        ...
        return $_SESSION[$name] ?? GetUrl("mmesinlist");
    }
    ...
    public function getModalCaption($pageName)
    {
        ...
        } elseif ($pageName == "mmesinedit") {
            return $Language->phrase("Edit");
        } elseif ($pageName == "mmesinadd") {
    ...
    {
        if ($parm != "") {
            $url = $this->keyUrl("mmesinview", $this->getUrlParm($parm));
        } else {
            $url = $this->keyUrl("mmesinview", $this->getUrlParm(Config("TABLE_SHOW_DETAIL") . "="));
        }
    ...
    {
        if ($parm != "") {
            $url = "mmesinadd?" . $this->getUrlParm($parm);
        } else {
            $url = "mmesinadd";
        }
        return $this->addMasterUrl($url);
    ...
    {
        $url = $this->keyUrl("mmesinedit", $this->getUrlParm($parm));
        return $this->addMasterUrl($url);
    }
    ...
    {
        $url = $this->keyUrl("mmesinadd", $this->getUrlParm($parm));
        return $this->addMasterUrl($url);
    }
    ...
    {
        return $this->keyUrl("mmesindelete", $this->getUrlParm());
    }
...
SORTHTML;
    ...
    public function renderEditRow()
    {
        ...
        $this->dalam_penyewaan->EditValue = $this->dalam_penyewaan->CurrentValue;
        ...
        $this->sisa_barang->EditValue = $this->sisa_barang->CurrentValue;
        ...
        if (!$doc->ExportCustom) {
            ...
            if ($doc->Horizontal) { // Horizontal format, write header
                ...
                if ($exportPageType == "view") {
                    ...
                    $doc->exportCaption($this->dalam_penyewaan);
                    $doc->exportCaption($this->sisa_barang);
            ...
            if ($recCnt >= $startRec) {
                ...
                if (!$doc->ExportCustom) {
                    ...
                    if ($exportPageType == "view") {
                        ...
                        $doc->exportField($this->dalam_penyewaan);
                        $doc->exportField($this->sisa_barang);
