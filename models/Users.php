...
class Users extends DbTable
{
    ...
    public function __construct()
    {
        ...
        // name
        $this->name = new DbField('users', 'users', 'x_name', 'name', '`name`', '`name`', 200, 255, -1, false, '`name`', false, false, false, 'FORMATTED TEXT', 'TEXT');
        ...
        // email
        $this->_email = new DbField('users', 'users', 'x__email', 'email', '`email`', '`email`', 200, 255, -1, false, '`email`', false, false, false, 'FORMATTED TEXT', 'TEXT');
        ...
        $this->email_verified_at->CustomMsg = $Language->FieldPhrase($this->TableVar, $this->email_verified_at->Param, "CustomMsg");
        ...
        $this->remember_token->CustomMsg = $Language->FieldPhrase($this->TableVar, $this->remember_token->Param, "CustomMsg");
        ...
        if (!$doc->ExportCustom) {
            ...
            if ($doc->Horizontal) { // Horizontal format, write header
                ...
                if ($exportPageType == "view") {
                    ...
                    $doc->exportCaption($this->email_verified_at);
            ...
            if ($recCnt >= $startRec) {
                ...
                if (!$doc->ExportCustom) {
                    ...
                    if ($exportPageType == "view") {
                        ...
                        $doc->exportField($this->email_verified_at);
