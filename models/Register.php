...
class Register extends Users
{
    ...
    public function run()
    {
        ...
        if ($this->isInsert()) {
            ...
            $filter = GetUserFilter(Config("LOGIN_USERNAME_FIELD_NAME"), $this->name->CurrentValue);
            ...
            if (!$userExists) {
                ...
                if ($this->addRow()) { // Add record
                    ...
                    // Auto login user
                    if ($Security->validateUser($this->name->CurrentValue, $this->_password->FormValue, true)) {
                        // Nothing to do
                    } else {
    ...
    protected function validateForm()
    {
        ...
        if ($this->name->Required) {
            if (!$this->name->IsDetailKey && EmptyValue($this->name->FormValue)) {
                $this->name->addErrorMessage($Language->phrase("EnterUserName"));
            }
        }
