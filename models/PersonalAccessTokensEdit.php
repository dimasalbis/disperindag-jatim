...
class PersonalAccessTokensEdit extends PersonalAccessTokens
{
        ...
        if (IsApi()) {
            ...
            if ($this->isShow()) {
                ...
                if ($this->TotalRecords <= 0) { // No record found
                    ...
                    $this->terminate("personalaccesstokenslist"); // Return to list page
                    return;
    ...
    protected function editRow()
    {
        ...
        if (!$rsold) {
            ...
            // tokenable_id
            $this->tokenable_id->setDbValueDef($rsnew, $this->tokenable_id->CurrentValue, 0, $this->tokenable_id->ReadOnly);
            ...
            // abilities
            $this->abilities->setDbValueDef($rsnew, $this->abilities->CurrentValue, null, $this->abilities->ReadOnly);

            // last_used_at
            $this->last_used_at->setDbValueDef($rsnew, UnFormatDateTime($this->last_used_at->CurrentValue, 0), null, $this->last_used_at->ReadOnly);

            // expires_at
            $this->expires_at->setDbValueDef($rsnew, UnFormatDateTime($this->expires_at->CurrentValue, 0), null, $this->expires_at->ReadOnly);
