 ...
 * Page class
 */
class PerusahaanPenampungView extends PerusahaanPenampung
{
    use MessagesTrait;
    ...
    // Page object name
    public $PageObjName = "PerusahaanPenampungView";
    ...
    public function run()
    {
        ...
        if ($this->isPageRequest()) { // Validate request
            ...
            switch ($this->CurrentAction) {
                case "show": // Get a record to display
                    ...
                    if (!$matchRecord) {
                        ...
                        $returnUrl = "perusahaanpenampunglist"; // No matching record, return to list
                    } else {
            ...
            $returnUrl = "perusahaanpenampunglist"; // Not page request, return to list
        }
        if ($returnUrl != "") {
