 ...
 * Page class
 */
class PenyewaanMesinDelete extends PenyewaanMesin
{
    use MessagesTrait;
    ...
    // Page object name
    public $PageObjName = "PenyewaanMesinDelete";
    ...
    public function run()
    {
        ...
        if ($filter == "") {
            $this->terminate("penyewaanmesinlist"); // Prevent SQL injection, return to list
            return;
        }
        ...
        if ($this->isShow()) { // Load records for display
            ...
            if ($this->TotalRecords <= 0) { // No record found, exit
                ...
                $this->terminate("penyewaanmesinlist"); // Return to list
                return;
            }
        }
