 ...
 * Page class
 */
class PembuatanMesinList extends PembuatanMesin
{
    use MessagesTrait;
    ...
    // Page object name
    public $PageObjName = "PembuatanMesinList";

    // Rendering View
    public $RenderingView = false;

    // Grid form hidden field names
    public $FormName = "fpembuatan_mesinlist";
    ...
    public function __construct()
    {
        ...
        $this->AddUrl = "pembuatanmesinadd";
        $this->InlineAddUrl = $pageUrl . "action=add";
        $this->GridAddUrl = $pageUrl . "action=gridadd";
        $this->GridEditUrl = $pageUrl . "action=gridedit";
        $this->MultiDeleteUrl = "pembuatanmesindelete";
        $this->MultiUpdateUrl = "pembuatanmesinupdate";
        ...
        $this->FilterOptions->TagClassName = "ew-filter-option fpembuatan_mesinlistsrch";
    ...
    public function getFilterList()
    {
        ...
        $filterList = Concat($filterList, $this->lama_pembuatan->AdvancedSearch->toJson(), ","); // Field lama_pembuatan
        $filterList = Concat($filterList, $this->pemesan->AdvancedSearch->toJson(), ","); // Field pemesan
    ...
    protected function processFilterList()
    {
        ...
        if (Post("ajax") == "savefilters") { // Save filter request (Ajax)
            ...
            $UserProfile->setSearchFilters(CurrentUserName(), "fpembuatan_mesinlistsrch", $filters);
    ...
    protected function restoreFilterList()
    {
        ...
        // Field spesifikasi
        $this->spesifikasi->AdvancedSearch->SearchValue = @$filter["x_spesifikasi"];
        $this->spesifikasi->AdvancedSearch->SearchOperator = @$filter["z_spesifikasi"];
        $this->spesifikasi->AdvancedSearch->SearchCondition = @$filter["v_spesifikasi"];
        $this->spesifikasi->AdvancedSearch->SearchValue2 = @$filter["y_spesifikasi"];
        $this->spesifikasi->AdvancedSearch->SearchOperator2 = @$filter["w_spesifikasi"];
        $this->spesifikasi->AdvancedSearch->save();
        ...
        // Field lama_pembuatan
        $this->lama_pembuatan->AdvancedSearch->SearchValue = @$filter["x_lama_pembuatan"];
        $this->lama_pembuatan->AdvancedSearch->SearchOperator = @$filter["z_lama_pembuatan"];
        $this->lama_pembuatan->AdvancedSearch->SearchCondition = @$filter["v_lama_pembuatan"];
        $this->lama_pembuatan->AdvancedSearch->SearchValue2 = @$filter["y_lama_pembuatan"];
        $this->lama_pembuatan->AdvancedSearch->SearchOperator2 = @$filter["w_lama_pembuatan"];
        $this->lama_pembuatan->AdvancedSearch->save();

        // Field pemesan
        $this->pemesan->AdvancedSearch->SearchValue = @$filter["x_pemesan"];
        $this->pemesan->AdvancedSearch->SearchOperator = @$filter["z_pemesan"];
        $this->pemesan->AdvancedSearch->SearchCondition = @$filter["v_pemesan"];
        $this->pemesan->AdvancedSearch->SearchValue2 = @$filter["y_pemesan"];
        $this->pemesan->AdvancedSearch->SearchOperator2 = @$filter["w_pemesan"];
        $this->pemesan->AdvancedSearch->save();
        ...
        // Field nomor_kontrak
        $this->nomor_kontrak->AdvancedSearch->SearchValue = @$filter["x_nomor_kontrak"];
        $this->nomor_kontrak->AdvancedSearch->SearchOperator = @$filter["z_nomor_kontrak"];
        $this->nomor_kontrak->AdvancedSearch->SearchCondition = @$filter["v_nomor_kontrak"];
        $this->nomor_kontrak->AdvancedSearch->SearchValue2 = @$filter["y_nomor_kontrak"];
        $this->nomor_kontrak->AdvancedSearch->SearchOperator2 = @$filter["w_nomor_kontrak"];
        $this->nomor_kontrak->AdvancedSearch->save();

        // Field tanggal_kontrak
        $this->tanggal_kontrak->AdvancedSearch->SearchValue = @$filter["x_tanggal_kontrak"];
        $this->tanggal_kontrak->AdvancedSearch->SearchOperator = @$filter["z_tanggal_kontrak"];
        $this->tanggal_kontrak->AdvancedSearch->SearchCondition = @$filter["v_tanggal_kontrak"];
        $this->tanggal_kontrak->AdvancedSearch->SearchValue2 = @$filter["y_tanggal_kontrak"];
        $this->tanggal_kontrak->AdvancedSearch->SearchOperator2 = @$filter["w_tanggal_kontrak"];
        $this->tanggal_kontrak->AdvancedSearch->save();

        // Field nilai_kontrak
        $this->nilai_kontrak->AdvancedSearch->SearchValue = @$filter["x_nilai_kontrak"];
        $this->nilai_kontrak->AdvancedSearch->SearchOperator = @$filter["z_nilai_kontrak"];
        $this->nilai_kontrak->AdvancedSearch->SearchCondition = @$filter["v_nilai_kontrak"];
        $this->nilai_kontrak->AdvancedSearch->SearchValue2 = @$filter["y_nilai_kontrak"];
        ...
        $this->upload_ktp->AdvancedSearch->SearchCondition = @$filter["v_upload_ktp"];
        $this->upload_ktp->AdvancedSearch->SearchValue2 = @$filter["y_upload_ktp"];
        $this->upload_ktp->AdvancedSearch->SearchOperator2 = @$filter["w_upload_ktp"];
        $this->upload_ktp->AdvancedSearch->save();

        // Field foto_mesin
        $this->foto_mesin->AdvancedSearch->SearchValue = @$filter["x_foto_mesin"];
        $this->foto_mesin->AdvancedSearch->SearchOperator = @$filter["z_foto_mesin"];
        $this->foto_mesin->AdvancedSearch->SearchCondition = @$filter["v_foto_mesin"];
    ...
    protected function basicSearchSql($arKeywords, $type)
    {
        ...
        $this->buildBasicSearchSql($where, $this->spesifikasi, $arKeywords, $type);
        $this->buildBasicSearchSql($where, $this->jumlah, $arKeywords, $type);
        $this->buildBasicSearchSql($where, $this->lama_pembuatan, $arKeywords, $type);
        $this->buildBasicSearchSql($where, $this->pemesan, $arKeywords, $type);
    ...
    protected function setupSortOrder()
    {
        ...
        if (Get("order") !== null) {
            ...
            $this->updateSort($this->lama_pembuatan); // lama_pembuatan
            $this->updateSort($this->pemesan); // pemesan
    ...
    protected function resetCmd()
    {
        ...
        if (StartsString("reset", $this->Command)) {
            ...
            if ($this->Command == "resetsort") {
                ...
                $this->spesifikasi->setSort("");
                $this->jumlah->setSort("");
                $this->lama_pembuatan->setSort("");
                $this->pemesan->setSort("");
                $this->alamat->setSort("");
    ...
    protected function setupOtherOptions()
    {
        ...
        $item->Body = "<a class=\"ew-action ew-multi-delete\" title=\"" . HtmlTitle($Language->phrase("DeleteSelectedLink")) . "\" data-caption=\"" . HtmlTitle($Language->phrase("DeleteSelectedLink")) . "\" href=\"#\" onclick=\"return ew.submitAction(event, {f:document.fpembuatan_mesinlist, url:'" . GetUrl($this->MultiDeleteUrl) . "', data:{action:'show'}});return false;\">" . $Language->phrase("DeleteSelectedLink") . "</a>";
        $item->Visible = $Security->canDelete();
        ...
        $item->Body = "<a class=\"ew-save-filter\" data-form=\"fpembuatan_mesinlistsrch\" href=\"#\" onclick=\"return false;\">" . $Language->phrase("SaveCurrentFilter") . "</a>";
        $item->Visible = true;
        $item = &$this->FilterOptions->add("deletefilter");
        $item->Body = "<a class=\"ew-delete-filter\" data-form=\"fpembuatan_mesinlistsrch\" href=\"#\" onclick=\"return false;\">" . $Language->phrase("DeleteFilter") . "</a>";
        $item->Visible = true;
    ...
    public function renderOtherOptions()
    {
        ...
        foreach ($this->ListActions->Items as $listaction) {
            if ($listaction->Select == ACTION_MULTIPLE) {
                ...
                $item->Body = '<a class="ew-action ew-list-action" title="' . HtmlEncode($caption) . '" data-caption="' . HtmlEncode($caption) . '" href="#" onclick="return ew.submitAction(event,jQuery.extend({f:document.fpembuatan_mesinlist},' . $listaction->toJson(true) . '));">' . $icon . '</a>';
    ...
    protected function setupSearchOptions()
    {
        ...
        $item->Body = "<a class=\"btn btn-default ew-search-toggle" . $searchToggleClass . "\" href=\"#\" role=\"button\" title=\"" . $Language->phrase("SearchPanel") . "\" data-caption=\"" . $Language->phrase("SearchPanel") . "\" data-toggle=\"button\" data-form=\"fpembuatan_mesinlistsrch\" aria-pressed=\"" . ($searchToggleClass == " active" ? "true" : "false") . "\">" . $Language->phrase("SearchLink") . "</a>";
        $item->Visible = true;
