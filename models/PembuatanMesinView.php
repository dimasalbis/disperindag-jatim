 ...
 * Page class
 */
class PembuatanMesinView extends PembuatanMesin
{
    use MessagesTrait;
    ...
    // Page object name
    public $PageObjName = "PembuatanMesinView";
    ...
    public function run()
    {
        ...
        if ($this->isPageRequest()) { // Validate request
            ...
            switch ($this->CurrentAction) {
                case "show": // Get a record to display
                    ...
                    if (!$matchRecord) {
                        ...
                        $returnUrl = "pembuatanmesinlist"; // No matching record, return to list
                    } else {
            ...
            $returnUrl = "pembuatanmesinlist"; // Not page request, return to list
        }
        if ($returnUrl != "") {
