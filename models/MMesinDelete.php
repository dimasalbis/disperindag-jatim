 ...
 * Page class
 */
class MMesinDelete extends MMesin
{
    use MessagesTrait;
    ...
    // Page object name
    public $PageObjName = "MMesinDelete";
    ...
    public function run()
    {
        ...
        if ($filter == "") {
            $this->terminate("mmesinlist"); // Prevent SQL injection, return to list
            return;
        }
        ...
        if ($this->isShow()) { // Load records for display
            ...
            if ($this->TotalRecords <= 0) { // No record found, exit
                ...
                $this->terminate("mmesinlist"); // Return to list
                return;
            }
        }
