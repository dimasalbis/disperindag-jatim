...
class UsersList extends Users
{
    ...
    public function getFilterList()
    {
        ...
        $filterList = Concat($filterList, $this->email_verified_at->AdvancedSearch->toJson(), ","); // Field email_verified_at
    ...
    protected function restoreFilterList()
    {
        ...
        $this->email_verified_at->AdvancedSearch->SearchValue = @$filter["x_email_verified_at"];
        $this->email_verified_at->AdvancedSearch->SearchOperator = @$filter["z_email_verified_at"];
        $this->email_verified_at->AdvancedSearch->SearchCondition = @$filter["v_email_verified_at"];
        $this->email_verified_at->AdvancedSearch->SearchValue2 = @$filter["y_email_verified_at"];
        $this->email_verified_at->AdvancedSearch->SearchOperator2 = @$filter["w_email_verified_at"];
        $this->email_verified_at->AdvancedSearch->save();
    ...
    protected function basicSearchSql($arKeywords, $type)
    {
        ...
        $this->buildBasicSearchSql($where, $this->remember_token, $arKeywords, $type);
        return $where;
    }
    ...
    protected function setupOtherOptions()
    {
        ...
        $item->Body = "<a class=\"ew-action ew-multi-delete\" title=\"" . HtmlTitle($Language->phrase("DeleteSelectedLink")) . "\" data-caption=\"" . HtmlTitle($Language->phrase("DeleteSelectedLink")) . "\" href=\"#\" onclick=\"return ew.submitAction(event, {f:document.fuserslist, url:'" . GetUrl($this->MultiDeleteUrl) . "', data:{action:'show'}});return false;\">" . $Language->phrase("DeleteSelectedLink") . "</a>";
        $item->Visible = $Security->canDelete();
