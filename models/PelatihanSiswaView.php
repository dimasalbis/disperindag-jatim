 ...
 * Page class
 */
class PelatihanSiswaView extends PelatihanSiswa
{
    use MessagesTrait;
    ...
    // Page object name
    public $PageObjName = "PelatihanSiswaView";
    ...
    public function run()
    {
        ...
        if ($this->isPageRequest()) { // Validate request
            ...
            switch ($this->CurrentAction) {
                case "show": // Get a record to display
                    ...
                    if (!$matchRecord) {
                        ...
                        $returnUrl = "pelatihansiswalist"; // No matching record, return to list
                    } else {
            ...
            $returnUrl = "pelatihansiswalist"; // Not page request, return to list
        }
        if ($returnUrl != "") {
