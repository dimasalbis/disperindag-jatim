...
/**
 * Table class for penyewaan_mesin
 */
class PenyewaanMesin extends DbTable
{
    protected $SqlFrom = "";
    ...
    public function __construct()
    {
        ...
        $this->TableVar = 'penyewaan_mesin';
        $this->TableName = 'penyewaan_mesin';
        $this->TableType = 'TABLE';

        // Update Table
        $this->UpdateTable = "`penyewaan_mesin`";
        $this->Dbid = 'DB';
        $this->ExportAll = true;
        ...
        // id
        $this->id = new DbField('penyewaan_mesin', 'penyewaan_mesin', 'x_id', 'id', '`id`', '`id`', 21, 20, -1, false, '`id`', false, false, false, 'FORMATTED TEXT', 'NO');
        ...
        // nama_mesin
        $this->nama_mesin = new DbField('penyewaan_mesin', 'penyewaan_mesin', 'x_nama_mesin', 'nama_mesin', '`nama_mesin`', '`nama_mesin`', 200, 255, -1, false, '`nama_mesin`', false, false, false, 'FORMATTED TEXT', 'TEXT');
        ...
        // no_seri
        $this->no_seri = new DbField('penyewaan_mesin', 'penyewaan_mesin', 'x_no_seri', 'no_seri', '`no_seri`', '`no_seri`', 200, 255, -1, false, '`no_seri`', false, false, false, 'FORMATTED TEXT', 'TEXT');
        ...
        // nama_penyewa
        $this->nama_penyewa = new DbField('penyewaan_mesin', 'penyewaan_mesin', 'x_nama_penyewa', 'nama_penyewa', '`nama_penyewa`', '`nama_penyewa`', 200, 255, -1, false, '`nama_penyewa`', false, false, false, 'FORMATTED TEXT', 'TEXT');
        ...
        // alamat
        $this->alamat = new DbField('penyewaan_mesin', 'penyewaan_mesin', 'x_alamat', 'alamat', '`alamat`', '`alamat`', 200, 255, -1, false, '`alamat`', false, false, false, 'FORMATTED TEXT', 'TEXT');
        ...
        // no_hp
        $this->no_hp = new DbField('penyewaan_mesin', 'penyewaan_mesin', 'x_no_hp', 'no_hp', '`no_hp`', '`no_hp`', 200, 255, -1, false, '`no_hp`', false, false, false, 'FORMATTED TEXT', 'TEXT');
        ...
        // nilai_sewa
        $this->nilai_sewa = new DbField('penyewaan_mesin', 'penyewaan_mesin', 'x_nilai_sewa', 'nilai_sewa', '`nilai_sewa`', '`nilai_sewa`', 200, 255, -1, false, '`nilai_sewa`', false, false, false, 'FORMATTED TEXT', 'TEXT');
        ...
        // created_at
        $this->created_at = new DbField('penyewaan_mesin', 'penyewaan_mesin', 'x_created_at', 'created_at', '`created_at`', CastDateFieldForLike("`created_at`", 0, "DB"), 135, 19, 0, false, '`created_at`', false, false, false, 'FORMATTED TEXT', 'TEXT');
        ...
        // updated_at
        $this->updated_at = new DbField('penyewaan_mesin', 'penyewaan_mesin', 'x_updated_at', 'updated_at', '`updated_at`', CastDateFieldForLike("`updated_at`", 0, "DB"), 135, 19, 0, false, '`updated_at`', false, false, false, 'FORMATTED TEXT', 'TEXT');
        ...
        // tanggal_sewa
        $this->tanggal_sewa = new DbField('penyewaan_mesin', 'penyewaan_mesin', 'x_tanggal_sewa', 'tanggal_sewa', '`tanggal_sewa`', CastDateFieldForLike("`tanggal_sewa`", 0, "DB"), 133, 10, 0, false, '`tanggal_sewa`', false, false, false, 'FORMATTED TEXT', 'TEXT');
        ...
        // tanggal_kembali
        $this->tanggal_kembali = new DbField('penyewaan_mesin', 'penyewaan_mesin', 'x_tanggal_kembali', 'tanggal_kembali', '`tanggal_kembali`', CastDateFieldForLike("`tanggal_kembali`", 0, "DB"), 133, 10, 0, false, '`tanggal_kembali`', false, false, false, 'FORMATTED TEXT', 'TEXT');
        ...
        // foto
        $this->foto = new DbField('penyewaan_mesin', 'penyewaan_mesin', 'x_foto', 'foto', '`foto`', '`foto`', 200, 255, -1, true, '`foto`', false, false, false, 'IMAGE', 'FILE');
        $this->foto->Required = true; // Required field
        ...
        // gambar_mesin
        $this->gambar_mesin = new DbField('penyewaan_mesin', 'penyewaan_mesin', 'x_gambar_mesin', 'gambar_mesin', '`gambar_mesin`', '`gambar_mesin`', 200, 255, -1, true, '`gambar_mesin`', false, false, false, 'IMAGE', 'FILE');
        ...
        // keterangan
        $this->keterangan = new DbField('penyewaan_mesin', 'penyewaan_mesin', 'x_keterangan', 'keterangan', '`keterangan`', '`keterangan`', 200, 100, -1, false, '`keterangan`', false, false, false, 'FORMATTED TEXT', 'TEXTAREA');
    ...
    {
        return ($this->SqlFrom != "") ? $this->SqlFrom : "`penyewaan_mesin`";
    }
    ...
    public function deleteUploadedFiles($row)
    {
        ...
        $oldFiles = EmptyValue($row['gambar_mesin']) ? [] : [$row['gambar_mesin']];
        foreach ($oldFiles as $oldFile) {
            if (file_exists($this->gambar_mesin->oldPhysicalUploadPath() . $oldFile)) {
    ...
    public function getReturnUrl()
    {
        ...
        return $_SESSION[$name] ?? GetUrl("penyewaanmesinlist");
    }
    ...
    public function getModalCaption($pageName)
    {
        ...
        } elseif ($pageName == "penyewaanmesinedit") {
            return $Language->phrase("Edit");
        } elseif ($pageName == "penyewaanmesinadd") {
    ...
    public function getApiPageName($action)
    {
        switch (strtolower($action)) {
            case Config("API_VIEW_ACTION"):
                return "PenyewaanMesinView";
            case Config("API_ADD_ACTION"):
                return "PenyewaanMesinAdd";
            case Config("API_EDIT_ACTION"):
                return "PenyewaanMesinEdit";
            case Config("API_DELETE_ACTION"):
                return "PenyewaanMesinDelete";
            case Config("API_LIST_ACTION"):
                return "PenyewaanMesinList";
            default:
                return "";
        }
    }
    ...
    {
        if ($parm != "") {
            $url = $this->keyUrl("penyewaanmesinview", $this->getUrlParm($parm));
        } else {
            $url = $this->keyUrl("penyewaanmesinview", $this->getUrlParm(Config("TABLE_SHOW_DETAIL") . "="));
        }
    ...
    {
        if ($parm != "") {
            $url = "penyewaanmesinadd?" . $this->getUrlParm($parm);
        } else {
            $url = "penyewaanmesinadd";
        }
        return $this->addMasterUrl($url);
    }
    ...
    {
        $url = $this->keyUrl("penyewaanmesinedit", $this->getUrlParm($parm));
        return $this->addMasterUrl($url);
    }
    ...
    {
        $url = $this->keyUrl("penyewaanmesinadd", $this->getUrlParm($parm));
        return $this->addMasterUrl($url);
    }
    ...
    {
        return $this->keyUrl("penyewaanmesindelete", $this->getUrlParm());
    }
...
SORTHTML;
    ...
    public function getFileData($fldparm, $key, $resize, $width = 0, $height = 0, $plugins = [])
    {
        ...
        if ($fldparm == 'foto') {
            $fldName = "foto";
            $fileNameFld = "gambar_mesin";
        } elseif ($fldparm == 'gambar_mesin') {
            $fldName = "gambar_mesin";
            $fileNameFld = "gambar_mesin";
        } else {
