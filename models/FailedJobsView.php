 ...
 * Page class
 */
class FailedJobsView extends FailedJobs
{
    use MessagesTrait;
    ...
    // Page object name
    public $PageObjName = "FailedJobsView";
    ...
    public function run()
    {
        ...
        if ($this->isPageRequest()) { // Validate request
            ...
            switch ($this->CurrentAction) {
                case "show": // Get a record to display
                    ...
                    if (!$matchRecord) {
                        ...
                        $returnUrl = "failedjobslist"; // No matching record, return to list
                    } else {
            ...
            $returnUrl = "failedjobslist"; // Not page request, return to list
        }
        if ($returnUrl != "") {
