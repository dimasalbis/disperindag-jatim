 ...
 * Page class
 */
class PembuatanMesinDelete extends PembuatanMesin
{
    use MessagesTrait;
    ...
    // Page object name
    public $PageObjName = "PembuatanMesinDelete";
    ...
    public function run()
    {
        ...
        if ($filter == "") {
            $this->terminate("pembuatanmesinlist"); // Prevent SQL injection, return to list
            return;
        }
        ...
        if ($this->isShow()) { // Load records for display
            ...
            if ($this->TotalRecords <= 0) { // No record found, exit
                ...
                $this->terminate("pembuatanmesinlist"); // Return to list
                return;
            }
        }
