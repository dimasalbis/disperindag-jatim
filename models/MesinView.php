...
class MesinView extends Mesin
{
    ...
    public function run()
    {
        ...
        if ($this->isPageRequest()) { // Validate request
            ...
            switch ($this->CurrentAction) {
                case "show": // Get a record to display
                    ...
                    if (!$matchRecord) {
                        ...
                        $returnUrl = "mesinlist"; // No matching record, return to list
                    } else {
            ...
            $returnUrl = "mesinlist"; // Not page request, return to list
        }
        if ($returnUrl != "") {
