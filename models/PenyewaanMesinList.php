 ...
 * Page class
 */
class PenyewaanMesinList extends PenyewaanMesin
{
    use MessagesTrait;
    ...
    // Page object name
    public $PageObjName = "PenyewaanMesinList";

    // Rendering View
    public $RenderingView = false;

    // Grid form hidden field names
    public $FormName = "fpenyewaan_mesinlist";
    ...
    public function __construct()
    {
        ...
        $this->AddUrl = "penyewaanmesinadd";
        $this->InlineAddUrl = $pageUrl . "action=add";
        $this->GridAddUrl = $pageUrl . "action=gridadd";
        $this->GridEditUrl = $pageUrl . "action=gridedit";
        $this->MultiDeleteUrl = "penyewaanmesindelete";
        $this->MultiUpdateUrl = "penyewaanmesinupdate";
        ...
        $this->FilterOptions->TagClassName = "ew-filter-option fpenyewaan_mesinlistsrch";
    ...
    public function getFilterList()
    {
        ...
        if (Config("SEARCH_FILTER_OPTION") == "Server" && isset($UserProfile)) {
            $savedFilterList = $UserProfile->getSearchFilters(CurrentUserName(), "fpenyewaan_mesinlistsrch");
        }
        $filterList = Concat($filterList, $this->id->AdvancedSearch->toJson(), ","); // Field id
        $filterList = Concat($filterList, $this->nama_mesin->AdvancedSearch->toJson(), ","); // Field nama_mesin
        $filterList = Concat($filterList, $this->no_seri->AdvancedSearch->toJson(), ","); // Field no_seri
        $filterList = Concat($filterList, $this->nama_penyewa->AdvancedSearch->toJson(), ","); // Field nama_penyewa
        ...
        $filterList = Concat($filterList, $this->tanggal_sewa->AdvancedSearch->toJson(), ","); // Field tanggal_sewa
        $filterList = Concat($filterList, $this->tanggal_kembali->AdvancedSearch->toJson(), ","); // Field tanggal_kembali
        $filterList = Concat($filterList, $this->foto->AdvancedSearch->toJson(), ","); // Field foto
        $filterList = Concat($filterList, $this->gambar_mesin->AdvancedSearch->toJson(), ","); // Field gambar_mesin
    ...
    protected function processFilterList()
    {
        ...
        if (Post("ajax") == "savefilters") { // Save filter request (Ajax)
            ...
            $UserProfile->setSearchFilters(CurrentUserName(), "fpenyewaan_mesinlistsrch", $filters);
    ...
    protected function restoreFilterList()
    {
        ...
        // Field nama_mesin
        $this->nama_mesin->AdvancedSearch->SearchValue = @$filter["x_nama_mesin"];
        $this->nama_mesin->AdvancedSearch->SearchOperator = @$filter["z_nama_mesin"];
        $this->nama_mesin->AdvancedSearch->SearchCondition = @$filter["v_nama_mesin"];
        $this->nama_mesin->AdvancedSearch->SearchValue2 = @$filter["y_nama_mesin"];
        $this->nama_mesin->AdvancedSearch->SearchOperator2 = @$filter["w_nama_mesin"];
        $this->nama_mesin->AdvancedSearch->save();

        // Field no_seri
        $this->no_seri->AdvancedSearch->SearchValue = @$filter["x_no_seri"];
        $this->no_seri->AdvancedSearch->SearchOperator = @$filter["z_no_seri"];
        $this->no_seri->AdvancedSearch->SearchCondition = @$filter["v_no_seri"];
        $this->no_seri->AdvancedSearch->SearchValue2 = @$filter["y_no_seri"];
        $this->no_seri->AdvancedSearch->SearchOperator2 = @$filter["w_no_seri"];
        $this->no_seri->AdvancedSearch->save();

        // Field nama_penyewa
        $this->nama_penyewa->AdvancedSearch->SearchValue = @$filter["x_nama_penyewa"];
        $this->nama_penyewa->AdvancedSearch->SearchOperator = @$filter["z_nama_penyewa"];
        $this->nama_penyewa->AdvancedSearch->SearchCondition = @$filter["v_nama_penyewa"];
        $this->nama_penyewa->AdvancedSearch->SearchValue2 = @$filter["y_nama_penyewa"];
        $this->nama_penyewa->AdvancedSearch->SearchOperator2 = @$filter["w_nama_penyewa"];
        $this->nama_penyewa->AdvancedSearch->save();
        ...
        // Field tanggal_sewa
        $this->tanggal_sewa->AdvancedSearch->SearchValue = @$filter["x_tanggal_sewa"];
        $this->tanggal_sewa->AdvancedSearch->SearchOperator = @$filter["z_tanggal_sewa"];
        $this->tanggal_sewa->AdvancedSearch->SearchCondition = @$filter["v_tanggal_sewa"];
        $this->tanggal_sewa->AdvancedSearch->SearchValue2 = @$filter["y_tanggal_sewa"];
        $this->tanggal_sewa->AdvancedSearch->SearchOperator2 = @$filter["w_tanggal_sewa"];
        $this->tanggal_sewa->AdvancedSearch->save();

        // Field tanggal_kembali
        $this->tanggal_kembali->AdvancedSearch->SearchValue = @$filter["x_tanggal_kembali"];
        $this->tanggal_kembali->AdvancedSearch->SearchOperator = @$filter["z_tanggal_kembali"];
        $this->tanggal_kembali->AdvancedSearch->SearchCondition = @$filter["v_tanggal_kembali"];
        $this->tanggal_kembali->AdvancedSearch->SearchValue2 = @$filter["y_tanggal_kembali"];
        $this->tanggal_kembali->AdvancedSearch->SearchOperator2 = @$filter["w_tanggal_kembali"];
        $this->tanggal_kembali->AdvancedSearch->save();
        ...
        // Field gambar_mesin
        $this->gambar_mesin->AdvancedSearch->SearchValue = @$filter["x_gambar_mesin"];
        $this->gambar_mesin->AdvancedSearch->SearchOperator = @$filter["z_gambar_mesin"];
        $this->gambar_mesin->AdvancedSearch->SearchCondition = @$filter["v_gambar_mesin"];
        $this->gambar_mesin->AdvancedSearch->SearchValue2 = @$filter["y_gambar_mesin"];
        $this->gambar_mesin->AdvancedSearch->SearchOperator2 = @$filter["w_gambar_mesin"];
        $this->gambar_mesin->AdvancedSearch->save();
    ...
    {
        $where = "";
        $this->buildBasicSearchSql($where, $this->nama_mesin, $arKeywords, $type);
        $this->buildBasicSearchSql($where, $this->no_seri, $arKeywords, $type);
        $this->buildBasicSearchSql($where, $this->nama_penyewa, $arKeywords, $type);
        ...
        $this->buildBasicSearchSql($where, $this->gambar_mesin, $arKeywords, $type);
    ...
    protected function setupSortOrder()
    {
        ...
        if (Get("order") !== null) {
            ...
            $this->updateSort($this->no_seri); // no_seri
            $this->updateSort($this->nama_penyewa); // nama_penyewa
            $this->updateSort($this->alamat); // alamat
            $this->updateSort($this->no_hp); // no_hp
            $this->updateSort($this->tanggal_sewa); // tanggal_sewa
            $this->updateSort($this->tanggal_kembali); // tanggal_kembali
            $this->updateSort($this->gambar_mesin); // gambar_mesin
    ...
    protected function resetCmd()
    {
        ...
        if (StartsString("reset", $this->Command)) {
            ...
            if ($this->Command == "resetsort") {
                ...
                $this->setSessionOrderBy($orderBy);
                $this->id->setSort("");
                $this->nama_mesin->setSort("");
                $this->no_seri->setSort("");
                $this->nama_penyewa->setSort("");
                $this->alamat->setSort("");
                $this->no_hp->setSort("");
                $this->nilai_sewa->setSort("");
                $this->created_at->setSort("");
                $this->updated_at->setSort("");
                $this->tanggal_sewa->setSort("");
                $this->tanggal_kembali->setSort("");
                $this->foto->setSort("");
                $this->gambar_mesin->setSort("");
    ...
    protected function setupOtherOptions()
    {
        ...
        $item->Body = "<a class=\"ew-action ew-multi-delete\" title=\"" . HtmlTitle($Language->phrase("DeleteSelectedLink")) . "\" data-caption=\"" . HtmlTitle($Language->phrase("DeleteSelectedLink")) . "\" href=\"#\" onclick=\"return ew.submitAction(event, {f:document.fpenyewaan_mesinlist, url:'" . GetUrl($this->MultiDeleteUrl) . "', data:{action:'show'}});return false;\">" . $Language->phrase("DeleteSelectedLink") . "</a>";
        $item->Visible = $Security->canDelete();
        ...
        $item->Body = "<a class=\"ew-save-filter\" data-form=\"fpenyewaan_mesinlistsrch\" href=\"#\" onclick=\"return false;\">" . $Language->phrase("SaveCurrentFilter") . "</a>";
        $item->Visible = true;
        $item = &$this->FilterOptions->add("deletefilter");
        $item->Body = "<a class=\"ew-delete-filter\" data-form=\"fpenyewaan_mesinlistsrch\" href=\"#\" onclick=\"return false;\">" . $Language->phrase("DeleteFilter") . "</a>";
        $item->Visible = true;
    ...
    public function renderOtherOptions()
    {
        ...
        foreach ($this->ListActions->Items as $listaction) {
            if ($listaction->Select == ACTION_MULTIPLE) {
                ...
                $item->Body = '<a class="ew-action ew-list-action" title="' . HtmlEncode($caption) . '" data-caption="' . HtmlEncode($caption) . '" href="#" onclick="return ew.submitAction(event,jQuery.extend({f:document.fpenyewaan_mesinlist},' . $listaction->toJson(true) . '));">' . $icon . '</a>';
    ...
    public function renderRow()
    {
        ...
        if ($this->RowType == ROWTYPE_VIEW) {
            ...
            if ($this->gambar_mesin->UseColorbox) {
                ...
                $this->gambar_mesin->LinkAttrs["data-rel"] = "penyewaan_mesin_x" . $this->RowCount . "_gambar_mesin";
    ...
    protected function setupSearchOptions()
    {
        ...
        $item->Body = "<a class=\"btn btn-default ew-search-toggle" . $searchToggleClass . "\" href=\"#\" role=\"button\" title=\"" . $Language->phrase("SearchPanel") . "\" data-caption=\"" . $Language->phrase("SearchPanel") . "\" data-toggle=\"button\" data-form=\"fpenyewaan_mesinlistsrch\" aria-pressed=\"" . ($searchToggleClass == " active" ? "true" : "false") . "\">" . $Language->phrase("SearchLink") . "</a>";
        $item->Visible = true;
