 ...
 * Page class
 */
class MMesinEdit extends MMesin
{
    use MessagesTrait;
        ...
        if (IsApi()) {
            ...
            if ($this->isShow()) {
                ...
                if ($this->TotalRecords <= 0) { // No record found
                    ...
                    $this->terminate("mmesinlist"); // Return to list page
                    return;
    ...
    protected function editRow()
    {
        ...
        if (!$rsold) {
            ...
            // gambar_mesin
            if ($this->gambar_mesin->Visible && !$this->gambar_mesin->ReadOnly && !$this->gambar_mesin->Upload->KeepFile) {
                $this->gambar_mesin->Upload->DbValue = $rsold['gambar_mesin']; // Get original value
            ...
            // dalam_penyewaan
            $this->dalam_penyewaan->setDbValueDef($rsnew, $this->dalam_penyewaan->CurrentValue, null, $this->dalam_penyewaan->ReadOnly);

            // sisa_barang
            $this->sisa_barang->setDbValueDef($rsnew, $this->sisa_barang->CurrentValue, null, $this->sisa_barang->ReadOnly);
