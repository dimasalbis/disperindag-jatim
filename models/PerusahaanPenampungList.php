 ...
 * Page class
 */
class PerusahaanPenampungList extends PerusahaanPenampung
{
    use MessagesTrait;
    ...
    // Page object name
    public $PageObjName = "PerusahaanPenampungList";

    // Rendering View
    public $RenderingView = false;

    // Grid form hidden field names
    public $FormName = "fperusahaan_penampunglist";
    ...
    public function __construct()
    {
        ...
        $this->AddUrl = "perusahaanpenampungadd";
        $this->InlineAddUrl = $pageUrl . "action=add";
        $this->GridAddUrl = $pageUrl . "action=gridadd";
        $this->GridEditUrl = $pageUrl . "action=gridedit";
        $this->MultiDeleteUrl = "perusahaanpenampungdelete";
        $this->MultiUpdateUrl = "perusahaanpenampungupdate";
        ...
        $this->FilterOptions->TagClassName = "ew-filter-option fperusahaan_penampunglistsrch";
    ...
    public function getFilterList()
    {
        ...
        $filterList = Concat($filterList, $this->no_telpon->AdvancedSearch->toJson(), ","); // Field no_telpon
        $filterList = Concat($filterList, $this->contact_person->AdvancedSearch->toJson(), ","); // Field contact_person
        $filterList = Concat($filterList, $this->bidang->AdvancedSearch->toJson(), ","); // Field bidang
    ...
    protected function processFilterList()
    {
        ...
        if (Post("ajax") == "savefilters") { // Save filter request (Ajax)
            ...
            $UserProfile->setSearchFilters(CurrentUserName(), "fperusahaan_penampunglistsrch", $filters);
    ...
    protected function restoreFilterList()
    {
        ...
        // Field no_telpon
        $this->no_telpon->AdvancedSearch->SearchValue = @$filter["x_no_telpon"];
        $this->no_telpon->AdvancedSearch->SearchOperator = @$filter["z_no_telpon"];
        $this->no_telpon->AdvancedSearch->SearchCondition = @$filter["v_no_telpon"];
        $this->no_telpon->AdvancedSearch->SearchValue2 = @$filter["y_no_telpon"];
        $this->no_telpon->AdvancedSearch->SearchOperator2 = @$filter["w_no_telpon"];
        $this->no_telpon->AdvancedSearch->save();
        ...
        // Field bidang
        $this->bidang->AdvancedSearch->SearchValue = @$filter["x_bidang"];
        $this->bidang->AdvancedSearch->SearchOperator = @$filter["z_bidang"];
        $this->bidang->AdvancedSearch->SearchCondition = @$filter["v_bidang"];
        $this->bidang->AdvancedSearch->SearchValue2 = @$filter["y_bidang"];
        $this->bidang->AdvancedSearch->SearchOperator2 = @$filter["w_bidang"];
        $this->bidang->AdvancedSearch->save();
    ...
    {
        $where = "";
        $this->buildBasicSearchSql($where, $this->nama_perusahaan, $arKeywords, $type);
        $this->buildBasicSearchSql($where, $this->alamat, $arKeywords, $type);
        $this->buildBasicSearchSql($where, $this->no_telpon, $arKeywords, $type);
        $this->buildBasicSearchSql($where, $this->contact_person, $arKeywords, $type);
        $this->buildBasicSearchSql($where, $this->bidang, $arKeywords, $type);
    ...
    protected function setupSortOrder()
    {
        ...
        if (Get("order") !== null) {
            ...
            $this->updateSort($this->no_telpon); // no_telpon
            $this->updateSort($this->contact_person); // contact_person
            $this->updateSort($this->bidang); // bidang
    ...
    protected function setupOtherOptions()
    {
        ...
        $item->Body = "<a class=\"ew-save-filter\" data-form=\"fperusahaan_penampunglistsrch\" href=\"#\" onclick=\"return false;\">" . $Language->phrase("SaveCurrentFilter") . "</a>";
        $item->Visible = true;
        $item = &$this->FilterOptions->add("deletefilter");
        $item->Body = "<a class=\"ew-delete-filter\" data-form=\"fperusahaan_penampunglistsrch\" href=\"#\" onclick=\"return false;\">" . $Language->phrase("DeleteFilter") . "</a>";
        $item->Visible = true;
    ...
    public function renderOtherOptions()
    {
        ...
        foreach ($this->ListActions->Items as $listaction) {
            if ($listaction->Select == ACTION_MULTIPLE) {
                ...
                $item->Body = '<a class="ew-action ew-list-action" title="' . HtmlEncode($caption) . '" data-caption="' . HtmlEncode($caption) . '" href="#" onclick="return ew.submitAction(event,jQuery.extend({f:document.fperusahaan_penampunglist},' . $listaction->toJson(true) . '));">' . $icon . '</a>';
    ...
    protected function setupSearchOptions()
    {
        ...
        $item->Body = "<a class=\"btn btn-default ew-search-toggle" . $searchToggleClass . "\" href=\"#\" role=\"button\" title=\"" . $Language->phrase("SearchPanel") . "\" data-caption=\"" . $Language->phrase("SearchPanel") . "\" data-toggle=\"button\" data-form=\"fperusahaan_penampunglistsrch\" aria-pressed=\"" . ($searchToggleClass == " active" ? "true" : "false") . "\">" . $Language->phrase("SearchLink") . "</a>";
        $item->Visible = true;
