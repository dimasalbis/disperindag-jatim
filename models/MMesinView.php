 ...
 * Page class
 */
class MMesinView extends MMesin
{
    use MessagesTrait;
    ...
    public function run()
    {
        ...
        if ($this->isPageRequest()) { // Validate request
            ...
            switch ($this->CurrentAction) {
                case "show": // Get a record to display
                    ...
                    if (!$matchRecord) {
                        ...
                        $returnUrl = "mmesinlist"; // No matching record, return to list
                    } else {
            ...
            $returnUrl = "mmesinlist"; // Not page request, return to list
        }
        if ($returnUrl != "") {
