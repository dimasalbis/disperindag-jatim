 ...
 * Page class
 */
class PersonalAccessTokensView extends PersonalAccessTokens
{
    use MessagesTrait;
    ...
    // Page object name
    public $PageObjName = "PersonalAccessTokensView";
    ...
    public function run()
    {
        ...
        if ($this->isPageRequest()) { // Validate request
            ...
            switch ($this->CurrentAction) {
                case "show": // Get a record to display
                    ...
                    if (!$matchRecord) {
                        ...
                        $returnUrl = "personalaccesstokenslist"; // No matching record, return to list
                    } else {
            ...
            $returnUrl = "personalaccesstokenslist"; // Not page request, return to list
        }
        if ($returnUrl != "") {
