 ...
 * Page class
 */
class PerusahaanPenampungDelete extends PerusahaanPenampung
{
    use MessagesTrait;
    ...
    // Page object name
    public $PageObjName = "PerusahaanPenampungDelete";
    ...
    public function run()
    {
        ...
        if ($filter == "") {
            $this->terminate("perusahaanpenampunglist"); // Prevent SQL injection, return to list
            return;
        }
        ...
        if ($this->isShow()) { // Load records for display
            ...
            if ($this->TotalRecords <= 0) { // No record found, exit
                ...
                $this->terminate("perusahaanpenampunglist"); // Return to list
                return;
            }
        }
