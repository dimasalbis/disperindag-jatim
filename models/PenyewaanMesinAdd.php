 ...
 * Page class
 */
class PenyewaanMesinAdd extends PenyewaanMesin
{
    use MessagesTrait;
    ...
    // Page object name
    public $PageObjName = "PenyewaanMesinAdd";
        ...
        switch ($this->CurrentAction) {
            case "copy": // Copy an existing record
                if (!$loaded) { // Record not loaded
                    ...
                    $this->terminate("penyewaanmesinlist"); // No matching record, return to list
                    return;
                }
                break;
            case "insert": // Add new record
                ...
                if ($this->addRow($this->OldRecordset)) { // Add successful
                    ...
                    } elseif (GetPageName($returnUrl) == "penyewaanmesinview") {
