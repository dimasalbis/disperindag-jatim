 ...
 * Page class
 */
class PendataanLahanView extends PendataanLahan
{
    use MessagesTrait;
    ...
    // Page object name
    public $PageObjName = "PendataanLahanView";
    ...
    public function run()
    {
        ...
        if ($this->isPageRequest()) { // Validate request
            ...
            switch ($this->CurrentAction) {
                case "show": // Get a record to display
                    ...
                    if (!$matchRecord) {
                        ...
                        $returnUrl = "pendataanlahanlist"; // No matching record, return to list
                    } else {
            ...
            $returnUrl = "pendataanlahanlist"; // Not page request, return to list
        }
        if ($returnUrl != "") {
