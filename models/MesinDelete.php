 ...
 * Page class
 */
class MesinDelete extends Mesin
{
    use MessagesTrait;
    ...
    // Page object name
    public $PageObjName = "MesinDelete";
    ...
    public function run()
    {
        ...
        if ($filter == "") {
            $this->terminate("mesinlist"); // Prevent SQL injection, return to list
            return;
        }
        ...
        if ($this->isShow()) { // Load records for display
            ...
            if ($this->TotalRecords <= 0) { // No record found, exit
                ...
                $this->terminate("mesinlist"); // Return to list
                return;
            }
        }
