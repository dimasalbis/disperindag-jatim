 ...
 * Page class
 */
class PendataanLahanDelete extends PendataanLahan
{
    use MessagesTrait;
    ...
    // Page object name
    public $PageObjName = "PendataanLahanDelete";
    ...
    public function run()
    {
        ...
        if ($filter == "") {
            $this->terminate("pendataanlahanlist"); // Prevent SQL injection, return to list
            return;
        }
        ...
        if ($this->isShow()) { // Load records for display
            ...
            if ($this->TotalRecords <= 0) { // No record found, exit
                ...
                $this->terminate("pendataanlahanlist"); // Return to list
                return;
            }
        }
