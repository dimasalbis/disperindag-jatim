 ...
 * Page class
 */
class PenyewaanMesinView extends PenyewaanMesin
{
    use MessagesTrait;
    ...
    // Page object name
    public $PageObjName = "PenyewaanMesinView";
    ...
    public function run()
    {
        ...
        if ($this->isPageRequest()) { // Validate request
            ...
            switch ($this->CurrentAction) {
                case "show": // Get a record to display
                    ...
                    if (!$matchRecord) {
                        ...
                        $returnUrl = "penyewaanmesinlist"; // No matching record, return to list
                    } else {
            ...
            $returnUrl = "penyewaanmesinlist"; // Not page request, return to list
        }
        if ($returnUrl != "") {
