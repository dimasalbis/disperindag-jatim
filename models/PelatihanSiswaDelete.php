 ...
 * Page class
 */
class PelatihanSiswaDelete extends PelatihanSiswa
{
    use MessagesTrait;
    ...
    // Page object name
    public $PageObjName = "PelatihanSiswaDelete";
    ...
    public function run()
    {
        ...
        if ($filter == "") {
            $this->terminate("pelatihansiswalist"); // Prevent SQL injection, return to list
            return;
        }
        ...
        if ($this->isShow()) { // Load records for display
            ...
            if ($this->TotalRecords <= 0) { // No record found, exit
                ...
                $this->terminate("pelatihansiswalist"); // Return to list
                return;
            }
        }
