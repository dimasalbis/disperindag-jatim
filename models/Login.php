...
class Login extends Users
{
    ...
    public function run()
    {
        ...
        $this->Username = new DbField("users", "users", "username", "username", "username", "", 202, 255, 0, false, "", false, false, false);
        $this->Username->EditAttrs->appendClass("form-control ew-control");
        $this->Password = new DbField("users", "users", "password", "password", "password", "", 202, 255, 0, false, "", false, false, false);
        $this->Password->EditAttrs->appendClass("form-control ew-control");
        if (Config("ENCRYPTED_PASSWORD")) {
            $this->Password->Raw = true;
        }
        $this->LoginType = new DbField("users", "users", "type", "logintype", "logintype", "", 202, 255, 0, false, "", false, false, false);
